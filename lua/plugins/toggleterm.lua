return {
  ...
  keys = {
    ...
    --Expo commands
    {
      mode = { 'n' },
      '<leader>rx',
      '<cmd>2TermExec cmd="WsaClient /launch wsa://com.veracitygroupinc.versatrak & npx expo start --dev-client" direction=float<cr>',
      desc = 'run expo',
    },
    {
      mode = { 'n' },
      '<leader>rcx',
      '<cmd>2TermExec cmd="WsaClient /launch wsa://com.veracitygroupinc.versatrak & npx expo start --clear --dev-client" direction=float<cr>',
